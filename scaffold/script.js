...
//     const newImages = files.slice(0, MAX_IMAGES - currentImages);

//     if (newImages.length + currentImages > MAX_IMAGES) {
...
//     const images = fileList.getElementsByTagName("img");
...
//     console.log("Saved to localStorage:", storedImagesData);
//   }
